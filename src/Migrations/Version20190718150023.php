...
final class Version20190718150023 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE map_cycle (id INT UNSIGNED AUTO_INCREMENT NOT NULL, cycle_config_id INT UNSIGNED DEFAULT NULL, name LONGTEXT NOT NULL, created_at DATETIME DEFAULT NULL, updated_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_30709EFFF58602F3 (cycle_config_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE map_cycle ADD CONSTRAINT FK_30709EFFF58602F3 FOREIGN KEY (cycle_config_id) REFERENCES cycle_config (id)');
        $this->addSql('ALTER TABLE cycle_maps_mami ADD CONSTRAINT FK_39C063895EC1162 FOREIGN KEY (cycle_id) REFERENCES map_cycle (id)');
        $this->addSql('ALTER TABLE cycle_maps_mami ADD CONSTRAINT FK_39C0638953C55F64 FOREIGN KEY (map_id) REFERENCES map (id)');
        $this->addSql('ALTER TABLE cycle_maps_user ADD CONSTRAINT FK_F17328035EC1162 FOREIGN KEY (cycle_id) REFERENCES map_cycle (id)');
        $this->addSql('ALTER TABLE cycle_maps_user ADD CONSTRAINT FK_F173280353C55F64 FOREIGN KEY (map_id) REFERENCES map (id)');
        $this->addSql('ALTER TABLE cycle_maps_default ADD CONSTRAINT FK_B46626FE5EC1162 FOREIGN KEY (cycle_id) REFERENCES map_cycle (id)');
        $this->addSql('ALTER TABLE cycle_maps_default ADD CONSTRAINT FK_B46626FE53C55F64 FOREIGN KEY (map_id) REFERENCES map (id)');
        $this->addSql('ALTER TABLE cycle_maps_default_category ADD CONSTRAINT FK_209C07C45EC1162 FOREIGN KEY (cycle_id) REFERENCES map_cycle (id)');
        ...
        $this->addSql('ALTER TABLE cycle_maps_origin ADD CONSTRAINT FK_8E62526A5EC1162 FOREIGN KEY (cycle_id) REFERENCES map_cycle (id)');
        $this->addSql('ALTER TABLE cycle_maps_origin ADD CONSTRAINT FK_8E62526A53C55F64 FOREIGN KEY (map_id) REFERENCES map (id)');
        $this->addSql('ALTER TABLE cycle_maps_random ADD CONSTRAINT FK_46A8DEA15EC1162 FOREIGN KEY (cycle_id) REFERENCES map_cycle (id)');
